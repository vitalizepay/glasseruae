  ...
  component: () => (
    <BlogPost
      ...
      sections={[
        ...
        { heading: "What Glass Is Used for Shower Enclosures in the UAE?", paragraphs: ["We use toughened tempered safety glass in 8mm and 10mm thickness, fully compliant with UAE building standards. All hardware — hinges, handles, channels — is marine-grade stainless steel or chrome-finished brass rated for high-humidity bathroom environments."] },
