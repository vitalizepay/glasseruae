      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "شركة Glasser Technical Works متخصصة في توريد وتركيب الزجاج العازل للصوت وقواطع الزجاج الصوتية في جميع أنحاء الإمارات منذ عام 2019، مع تصنيع داخلي لإطارات الألمنيوم في القصيص وأكثر من 500 مشروع منفذ. للاستفسار عن تركيب زجاج عازل للصوت في دبي أو أي إمارة أخرى، يمكنكم التواصل معنا على الرقم +971568400838 أو عبر البريد الإلكتروني sales@glasseruae.com للحصول على عرض سعر مجاني وزيارة موقعية.",
          ],
        },
      ]}
      serviceLinks={[
