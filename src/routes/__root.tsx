...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Glasser UAE — Premium Glass & Aluminium, Dubai" },
      { name: "description", content: "Dubai's trusted glass & aluminium experts. Frameless partitions, shower enclosures, aluminium doors & windows across the UAE." },
      ...
      { property: "og:title", content: "Glasser UAE — Premium Glass & Aluminium, Dubai" },
      { name: "twitter:title", content: "Glasser UAE — Premium Glass & Aluminium, Dubai" },
